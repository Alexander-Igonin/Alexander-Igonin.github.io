class Level6 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(20, 20, 'LEVEL 6');
        this.add.image(640, 410, 'target');

        this.matter.add.image(400, 400, 'block',null ,{ isStatic: true});
        ...
        this.inventorySquare3 = this.matter.add.image(500, 550, 'block');
        this.inventorySquare3.setInteractive();
        this.inventorySquare3.setStatic(true);
        this.inventorySquare3.on('pointerdown', function() {
            this.inventorySquare3.setStatic(false);
            this.inventorySquare3.setFixedRotation();
        }, this)
        this.inventorySquare3.on('pointerup', function() {
            this.inventorySquare3.setStatic(true);
        }, this)
        ...
        this.inventoryRightTriangle = this.matter.add.sprite(600, 560, 'right_triangle', null, { shape: this.shapes.right_triangle}).setScale(1.2);
