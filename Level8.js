class Level8 extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(20, 20, 'LEVEL 8');
        this.add.image(580, 290, 'target');

        // this.matter.add.image(160, 400, 'block',null ,{ isStatic: true});
        this.matter.add.image(160, 400, 'block',null ,{ isStatic: true});
        this.matter.add.image(280, 400, 'block',null ,{ isStatic: true});
        ...
        this.matter.add.image(580, 340, 'block',null ,{ isStatic: true});
        ...
        this.inventoryRightTriangle2 = this.matter.add.sprite(500, 560, 'right_triangle', null, { shape: this.shapes.right_triangle}).setScale(1.2);
        this.inventoryRightTriangle2.setInteractive();
        this.inventoryRightTriangle2.setStatic(true);
        
        this.inventoryRightTriangle2.on('pointerdown', function() {
            this.inventoryRightTriangle2.setStatic(false);
            this.inventoryRightTriangle2.setFixedRotation();
        }, this)
        this.inventoryRightTriangle2.on('pointerup', function() {
            this.inventoryRightTriangle2.setStatic(true);
        }, this)
